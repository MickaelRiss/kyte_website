        ...
        <div className="w-full bg-background/80 border border-border rounded-lg px-4 py-4 space-y-4">            
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs text-muted whitespace-nowrap">You keep this</span>
                    <Button variant="outline" size="sm" className="gap-1.5 border-border text-foreground text-xs h-8 px-3">
                        <Download size={12} />
                        <span>QR</span>
                    </Button>
                    <Button variant="outline" size="sm" className="gap-1.5 border-border text-foreground text-xs h-8 px-3">
