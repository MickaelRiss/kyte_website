...
export default function HeroSection() {
  return (
        <div className="relative isolate px-6 pt-36 md:pt-50 lg:px-8">
                ...
                <div className="text-center mt-8">
                    ...
                    <FadeInView delay={0.3}>
                        <p className="mt-8 text-lg text-pretty text-gray-400 sm:text-xl/8">
                            Turn your seed phrase into distributed shards using Shamir&apos;s Secret Sharing. Eliminate single points of failure with developer-grade cryptography tools.
                        </p>
                    </FadeInView>
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        <FadeInView delay={0.4}>
                            <Button className="text-foreground" variant="outline">Join Waitlist</Button>
                        </FadeInView>
                        <FadeInView delay={0.5}>
                            <Button className="text-foreground bg-primary/90">Get Started</Button>
                        </FadeInView>
                    </div>
                </div>
            </div>
