            ...
            <FadeInView delay={0.1}>
                <div className="bg-card/80 border border-border px-6 py-6 rounded-md mt-6 flex flex-col gap-8 justify-between items-center md:flex-row md:gap-18 shadow-lg">
                    <div className="">
                        ...
                        <h3 className="text-lg font-semibold my-2">Zero-Knowledge Architecture</h3>
                        <p className="text-sm text-muted leading-relaxed">
                            Everything happends locally on your machine. Kyte never sees your keys, your seed phrase or your shards. We provide the math, you control the secrets.
                        </p>
                    </div>
                    <Image
